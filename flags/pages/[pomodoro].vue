<template>
    <div class="w-full h-[100vh] flex flex-col md:flex-row">
      ...
      <div class="md:w-2/3 w-full flex flex-col items-center p-2 justify-center" v-show="value2">
        ...
        />
        <button
          class="bg-gray-800 py-2 px-6 rounded-full md:w-1/2 w-full text-white mt-4"
          @click="startTimer"
        >
          Submit
        </button>
      ...
      <div class="md:w-2/3 w-full flex flex-col items-center p-2 justify-center" v-show="value1">
        <svg height="100px" width="100px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <path d="M15.24 2H8.76004C5.00004 2 4.71004 5.38 6.74004 7.22L17.26 16.78C19.29 18.62 19 22 15.24 22H8.76004C5.00004 22 4.71004 18.62 6.74004 16.78L17.26 7.22C19.29 5.38 19 2 15.24 2Z" stroke="#e8e8e8" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"></path> </g></svg>
      <div>
        <p></p>
      </div>
      </div>
